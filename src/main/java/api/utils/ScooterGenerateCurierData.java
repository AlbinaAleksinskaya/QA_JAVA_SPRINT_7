...
public class ScooterGenerateCurierData {
    private CourierClient courierApiClient = new CourierClient();
    ...
    public int createRandomCourier() {
        ...
        ValidatableResponse responseCourier = (ValidatableResponse) courierApiClient.loginCourier(CourierCredentials.getCredentials(courier));
